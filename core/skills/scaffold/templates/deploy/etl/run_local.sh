...
PIPELINE_KEY="TPLVAR_RESOURCE_KEY_pipeline"
...
echo "======================================================"
echo "  ETL Bundle Deploy (DEV) — TPLVAR_SLUG"
echo "======================================================"
...
echo ""
echo "==> Done. To run the pipeline in dev:"
echo "    databricks bundle run $PIPELINE_KEY -t dev"
echo "    databricks bundle run $PIPELINE_KEY -t dev --full-refresh"
echo ""

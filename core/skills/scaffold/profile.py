...
FIELDS = [
    ...
    (
        ...
        "Dev workspace URL",
        "https://my-dev.cloud.databricks.com",
    ...
    (
        ...
        "https://my-stg.cloud.databricks.com",
        "databricks.yml targets.stg.workspace.host",
        "Databricks admin",
    ),
    (
        "prod_workspace_host",
        ...
        "https://my-prod.cloud.databricks.com",
        "databricks.yml targets.prod.workspace.host",
        "Databricks admin",
    ),
    (
        "stg_service_principal",
        "Service Principals",
        "Staging run_as service principal id",
        "00000000-0000-0000-0000-000000000000",
        "databricks.yml targets.stg.run_as + root_path",
        "platform team (created at registration)",
    ),
    (
        "prod_service_principal",
        "Service Principals",
        "Production run_as service principal id",
        "00000000-0000-0000-0000-000000000000",
        "databricks.yml targets.prod.run_as + root_path",
        "platform team (created at registration)",
    ),
    (
        "stg_developers_group",
        "Permissions",
        "Workspace group granted CAN_MANAGE in stg",
        "my-team-developers-stg",
        "databricks.yml targets.stg.permissions",
        "Databricks admin (workspace group name)",
    ),
    (
        "prod_developers_group",
        "Permissions",
        "Workspace group granted CAN_MANAGE in prod",
        "my-team-developers",
